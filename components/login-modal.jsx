...
export default function LoginModal({ isOpen, onClose, action }) {
  ...
  const headerMessage = () => {
    ...
    return (
      <>
        <ThemedText>
          Welcome to&nbsp;<Emphasis>YellowJobs</Emphasis>
        </ThemedText>
        &nbsp;
        {/*star-struck-emoji*/}
        <svg
