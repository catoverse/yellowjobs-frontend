define('./workbox-e604aefe.js', ['exports'], function (t) {
  'use strict'
  try {
  ...
  function k(t) {
    return t !== IDBDatabase.prototype.transaction ||
      ...
      : function (e, ...s) {
          ...
          return E.set(n, e.sort ? e.sort() : [e]), B(n)
        }
  }
  function O(t) {
      ...
      this.L(t),
        this._ &&
          (function (t, { blocked: e } = {}) {
            ...
            e && s.addEventListener('blocked', () => e()), B(s).then(() => {})
          })(this._)
    }
  ...
  class F {
    ...
    async expireEntries() {
      ...
      const t = this.B ? Date.now() - 1e3 * this.B : 0,
        e = await this.M.expireEntries(t, this.O),
        s = await self.caches.open(this._)
      for (const t of e) await s.delete(t, this.T)
  ...
  class V {
    constructor({ precacheController: t }) {
      ;(this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
        const s = (e && e.cacheKey) || this.P.getCacheKeyForURL(t.url)
