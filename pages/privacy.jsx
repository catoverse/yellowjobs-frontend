    ...
    <>
      ...
      >
        ...
        <Text mt="2">
          ...
          collect, use and share your personal information and to assist you in
          exercising the privacy rights available to you. We care for your
        ...
        <Text mt="2">
          ...
          hard to give you the control to this mechanism. To give you a glimpse,
          these are some of the events we listen to —
        </Text>
        <UnorderedList ml="8">
        ...
        <Text mt="2">
          ...
          <Link href="http://api.yellowjobs.org" isExternal color="yellow.500">
            api.yellowjobs.org
          </Link>
        </Text>
        ...
        <Text mt="2">
          It should be noted that whether or not to send us your feedback or bug
          report is a completely voluntary initiative upon your own decision. If
          you have concern about your Personal Identifiable Information is being
          misused, or if you want further information about our privacy policy
          and what it means, please feel free to email us at,{' '}
